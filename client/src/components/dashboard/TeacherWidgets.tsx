...
import { Plus, Users, FileText, BarChart3, BookOpen, Settings, Award, Clock } from 'lucide-react';
  ...
  const quickActions = [
    {
      ...
      description: 'Yangi test yarating'
    },
    {
      label: 'O\'quvchilar',
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-6 shadow-sm hover:shadow-md transition-all duration-300">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-2xl font-bold text-blue-900">{tests.length}</span>
          </div>
          <h3 className="text-lg font-semibold text-blue-900 mb-1">Mening testlarim</h3>
          <p className="text-sm text-blue-600">Yaratilgan testlar soni</p>
        </div>
        ...
        <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-6 shadow-sm hover:shadow-md transition-all duration-300">
          ...
          <h3 className="text-lg font-semibold text-green-900 mb-1">O'quvchilar</h3>
          <p className="text-sm text-green-600">Ro'yxatdan o'tgan o'quvchilar</p>
        </div>
        ...
        <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl p-6 shadow-sm hover:shadow-md transition-all duration-300">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-2xl font-bold text-purple-900">{attempts.length}</span>
          </div>
          <h3 className="text-lg font-semibold text-purple-900 mb-1">Jami urinishlar</h3>
          <p className="text-sm text-purple-600">Barcha test urinishlari</p>
        </div>
      </div>
      ...
      {completedAttempts.length > 0 && (
        <div className="bg-gradient-to-r from-white to-green-50 rounded-2xl p-6 shadow-sm">
          <h3 className="text-xl font-semibold text-green-900 mb-6">So'nggi test urinishlari</h3>

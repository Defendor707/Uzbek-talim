      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <Card className="bg-gradient-to-r from-blue-500 to-blue-600 text-white">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-blue-100 text-sm">Jami darsliklar</p>
          ...
          <Card className="bg-gradient-to-r from-green-500 to-green-600 text-white">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-green-100 text-sm">Faol darsliklar</p>
          ...
          <Card className="bg-gradient-to-r from-purple-500 to-purple-600 text-white">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-purple-100 text-sm">Jami testlar</p>
          ...
          <Card className="bg-gradient-to-r from-orange-500 to-orange-600 text-white">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-orange-100 text-sm">Faol testlar</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <p className="text-gray-600 text-sm mb-4">Turli xil test turlari bilan yangi test yarating</p>
          ...
          <Card className="hover:shadow-lg transition-shadow">
            <CardHeader>
              <CardTitle className="flex items-center space-x-2">
                ...
                <span>Yangi darslik</span>
              </CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-600 text-sm mb-4">O'quvchilar uchun yangi darslik materiali yuklang</p>
          ...
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <p className="text-gray-600 text-sm mb-4">O'quvchilar faoliyati va test natijalarini ko'ring</p>
          ...
          <CardContent>
            {(tests && tests.length > 0) || (lessons && lessons.length > 0) ? (
                ...
                {tests?.slice(0, 3).map((test, index) => (
                  <div key={index} className="flex items-center space-x-4 p-3 bg-gray-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600">Test - {test.status}</p>
                    </div>
                ...
                {lessons?.slice(0, 2).map((lesson, index) => (
                  <div key={index} className="flex items-center space-x-4 p-3 bg-gray-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600">Darslik - {lesson.grade || 'Umumiy'}</p>
                    </div>
                    <span className="text-xs text-gray-500">
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-500">Hali hech qanday faoliyat yo'q</p>
                <p className="text-sm text-gray-400 mt-1">Birinchi test yoki darslik yaratishdan boshlang</p>
              </div>
            )}
          </CardContent>
        </Card>
